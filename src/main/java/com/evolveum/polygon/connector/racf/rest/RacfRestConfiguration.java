...
public class RacfRestConfiguration extends AbstractConfiguration {

    private static final Log LOG = Log.getLog(RacfRestConfiguration.class);
    ...
    @ConfigurationProperty(
            displayMessageKey = "racfrest.config.url",
            helpMessageKey = "racfrest.config.url.help",
            order = 10
    )
    ...
    @ConfigurationProperty(
            displayMessageKey = "racfrest.config.username",
            helpMessageKey = "racfrest.config.username.help",
            order = 10
    )
    ...
    @ConfigurationProperty(
            displayMessageKey = "racfrest.config.password",
            helpMessageKey = "racfrest.config.password.help",
            order = 10
    )
