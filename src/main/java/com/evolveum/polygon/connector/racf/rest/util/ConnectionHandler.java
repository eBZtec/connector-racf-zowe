...
import com.evolveum.polygon.connector.racf.rest.RacfRestConfiguration;
...
public abstract class ConnectionHandler {
    ...
    public ConnectionHandler(RacfRestConfiguration configuration) { this.configuration = configuration; }
    ...
    protected void setConfiguration(RacfRestConfiguration configuration) { this.configuration = configuration; }
}
